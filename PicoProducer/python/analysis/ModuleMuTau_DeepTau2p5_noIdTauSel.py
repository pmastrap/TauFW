...
class ModuleMuTau_DeepTau2p5_noIdTauSel(ModuleTauPair):
  
  def __init__(self, fname, **kwargs):
    kwargs['channel'] = 'mutau'
    super(ModuleMuTau_DeepTau2p5_noIdTauSel,self).__init__(fname,**kwargs)
  ...
  def beginJob(self):
    ...
    super(ModuleMuTau_DeepTau2p5_noIdTauSel,self).beginJob()
