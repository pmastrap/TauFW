...
class ModuleMuTau_DeepTau2p5_2p5Sel(ModuleTauPair):
  
  def __init__(self, fname, **kwargs):
    kwargs['channel'] = 'mutau'
    super(ModuleMuTau_DeepTau2p5_2p5Sel,self).__init__(fname,**kwargs)
  ...
  def beginJob(self):
    ...
    super(ModuleMuTau_DeepTau2p5_2p5Sel,self).beginJob()
  ...
  def analyze(self, event):
    ...
    for tau in Collection(event,'Tau'):
      ...
      if tau.idDeepTau2018v2p5VSmu<1: continue # Medium
      if tau.idDeepTau2018v2p5VSjet<1: continue #Medium
