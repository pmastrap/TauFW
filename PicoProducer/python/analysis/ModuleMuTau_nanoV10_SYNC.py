...
class ModuleMuTau_nanoV10_SYNC(ModuleTauPair):
  
  def __init__(self, fname, **kwargs):
    kwargs['channel'] = 'mutau'
    super(ModuleMuTau_nanoV10_SYNC,self).__init__(fname,**kwargs)
  ...
  def beginJob(self):
    ...
    super(ModuleMuTau_nanoV10_SYNC,self).beginJob()
  ...
  def analyze(self, event):
    ...
    self.out.tVVVLooseDeepTau2018v2p5VSjet_2[0]= tau.idDeepTau2018v2p5VSjet >= 1
    self.out.tVVVLooseDeepTau2018v2p5VSe_2[0]  = tau.idDeepTau2018v2p5VSe >= 1

    self.out.tVVLooseDeepTau2018v2p5VSjet_2[0] = tau.idDeepTau2018v2p5VSjet >= 2
    self.out.tVVLooseDeepTau2018v2p5VSe_2[0]   = tau.idDeepTau2018v2p5VSe >= 2

    self.out.tVLooseDeepTau2018v2p5VSjet_2[0]  = tau.idDeepTau2018v2p5VSjet >= 3
    self.out.tVLooseDeepTau2018v2p5VSe_2[0]    = tau.idDeepTau2018v2p5VSe >= 3
    self.out.tVLooseDeepTau2018v2p5VSmu_2[0]    = tau.idDeepTau2018v2p5VSmu >= 1

    self.out.tLooseDeepTau2018v2p5VSe_2[0]     = tau.idDeepTau2018v2p5VSe >= 4
    self.out.tLooseDeepTau2018v2p5VSjet_2[0]   = tau.idDeepTau2018v2p5VSjet >= 4
    self.out.tLooseDeepTau2018v2p5VSmu_2[0]    = tau.idDeepTau2018v2p5VSmu >= 2 

    self.out.tMediumDeepTau2018v2p5VSe_2[0]     = tau.idDeepTau2018v2p5VSe >= 5
    self.out.tMediumDeepTau2018v2p5VSjet_2[0]   = tau.idDeepTau2018v2p5VSjet >= 5
    self.out.tMediumDeepTau2018v2p5VSmu_2[0]    = tau.idDeepTau2018v2p5VSmu >= 3

    self.out.tTightDeepTau2018v2p5VSe_2[0]     = tau.idDeepTau2018v2p5VSe >= 6
    self.out.tTightDeepTau2018v2p5VSjet_2[0]   = tau.idDeepTau2018v2p5VSjet >= 6
    self.out.tTightDeepTau2018v2p5VSmu_2[0]    = tau.idDeepTau2018v2p5VSmu >= 4  

    self.out.tVTightDeepTau2018v2p5VSe_2[0]     = tau.idDeepTau2018v2p5VSe >= 7
    self.out.tVTightDeepTau2018v2p5VSjet_2[0]   = tau.idDeepTau2018v2p5VSjet >= 7

    self.out.tVVTightDeepTau2018v2p5VSe_2[0]     = tau.idDeepTau2018v2p5VSe >= 8
    self.out.tVVTightDeepTau2018v2p5VSjet_2[0]   = tau.idDeepTau2018v2p5VSjet >= 8
    
    self.out.tVVVLooseDeepTau2017v2p1VSjet_2[0]= tau.idDeepTau2017v2p1VSjet >= 1
    self.out.tVVVLooseDeepTau2017v2p1VSe_2[0]  = tau.idDeepTau2017v2p1VSe >= 1

    self.out.tVVLooseDeepTau2017v2p1VSjet_2[0] = tau.idDeepTau2017v2p1VSjet >= 2
    self.out.tVVLooseDeepTau2017v2p1VSe_2[0]   = tau.idDeepTau2017v2p1VSe >= 2

    self.out.tVLooseDeepTau2017v2p1VSjet_2[0]  = tau.idDeepTau2017v2p1VSjet >= 3
    self.out.tVLooseDeepTau2017v2p1VSe_2[0]    = tau.idDeepTau2017v2p1VSe >= 3
    self.out.tVLooseDeepTau2017v2p1VSmu_2[0]    = tau.idDeepTau2017v2p1VSmu >= 1

    self.out.tLooseDeepTau2017v2p1VSe_2[0]     = tau.idDeepTau2017v2p1VSe >= 4
    self.out.tLooseDeepTau2017v2p1VSjet_2[0]   = tau.idDeepTau2017v2p1VSjet >= 4
    self.out.tLooseDeepTau2017v2p1VSmu_2[0]    = tau.idDeepTau2017v2p1VSmu >= 2 

    self.out.tMediumDeepTau2017v2p1VSe_2[0]     = tau.idDeepTau2017v2p1VSe >= 5
    self.out.tMediumDeepTau2017v2p1VSjet_2[0]   = tau.idDeepTau2017v2p1VSjet >= 5
    self.out.tMediumDeepTau2017v2p1VSmu_2[0]    = tau.idDeepTau2017v2p1VSmu >= 3

    self.out.tTightDeepTau2017v2p1VSe_2[0]     = tau.idDeepTau2017v2p1VSe >= 6
    self.out.tTightDeepTau2017v2p1VSjet_2[0]   = tau.idDeepTau2017v2p1VSjet >= 6
    self.out.tTightDeepTau2017v2p1VSmu_2[0]    = tau.idDeepTau2017v2p1VSmu >= 4  

    self.out.tVTightDeepTau2017v2p1VSe_2[0]     = tau.idDeepTau2017v2p1VSe >= 7
    self.out.tVTightDeepTau2017v2p1VSjet_2[0]   = tau.idDeepTau2017v2p1VSjet >= 7

    self.out.tVVTightDeepTau2017v2p1VSe_2[0]     = tau.idDeepTau2017v2p1VSe >= 8
    self.out.tVVTightDeepTau2017v2p1VSjet_2[0]   = tau.idDeepTau2017v2p1VSjet >= 8
    ...
    self.out.tHLT_IsoMu24[0]               = event.HLT_IsoMu24
    self.out.tHLT_IsoMu27[0]               = event.HLT_IsoMu27  
